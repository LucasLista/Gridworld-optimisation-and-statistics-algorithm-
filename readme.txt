...
Statistics.py is the statistics program that generated our statistics
...
AI_GridWorld.py a training algorithm for the game with the specific epsilon-value 10. This is what is simulated in Statistics.py with many different epsilon values and many different times
